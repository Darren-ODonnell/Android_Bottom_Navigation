...
//        RegisterRepository service = new LoginRepository();
//        PlayerRepository playerRepository = new PlayerRepository();
//
//
//        findViewById(R.id.login).setOnClickListener(v -> {
//            String email = getTextFromEditText(R.id.emailReg);
//            String username = getTextFromEditText(R.id.nameReg);
//            String password = getTextFromEditText(R.id.passwordReg);
//            String passwordConfirm = getTextFromEditText(R.id.passwordConfReg);
//
//
//
